...
public class OperadorModelo {
    ...
    private String conectarYEnviar(String ip, int puerto, String comando) throws Exception {
	    ...
	    public String llamarSiguiente() {
	        ...
	        if (res != null && res.startsWith("OK_LLAMAR" + Protocolo.SEPARADOR)) {
	            
	            String[] partes = res.split(Protocolo.SEPARADOR);
	            String dniCifrado = partes[1];
	            
	            
	            String dniDescifrado = seguridad.SeguridadFacade.descifrarDni(dniCifrado);
	            
	            this.clienteActual = dniDescifrado;
	            this.reintentosAgotados = false;
	            
	            return dniDescifrado; 
	        }
